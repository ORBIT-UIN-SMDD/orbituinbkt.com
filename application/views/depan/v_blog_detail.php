...
<head>
    ...
    <title><?php echo $title; ?> | UKM ORBIT UIN Sjech M.Djamil Djambek Bukittinggi</title>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 offset-md-1">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="blogpost-tab-description">
                                                            <h6 class="text-success"><?php echo $res->komentar_nama; ?><small> <?php if ($res->akses == 2) {
                                                                                                                                    echo '(humas)';
                                                                                                                                } else {
                                                                                                                                    echo '(admin)';
                                                                                                                                }; ?></small></h6><small><em><?php echo date("d M Y H:i", strtotime($res->komentar_tanggal)); ?></em></small>
