...
<meta charset="utf-8">
    ...
    <title>BLOG | UKM ORBIT UIN Sjech M.Djamil Djambek Bukittinggi</title>
    ...
    <meta property="og:title" content="BLOG | UKM ORBIT UIN Sjech M.Djamil Djambek Bukittinggi" />
                    ...
                    <?php foreach ($data->result() as $row) : ?>
                        <div class="blog-single-item">
                            ...
                            <div class="blog-tiltle_block mb-5">
                                ...
                                <a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>" class="btn btn-outline-danger tombol pl-3 pr-3 mt-4">Baca Selengkapnya <i class="fa fa-chevron-right faa-passing animated pl-2 faa-fast" aria-hidden="true"></i></a>
                                <hr>
                            </div>
                        </div>
                    <?php endforeach; ?>
