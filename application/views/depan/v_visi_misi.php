...
<head>
    ...
    <title>Visi Misi | UKM ORBIT UIN Sjech M.Djamil Djambek Bukittinggi</title>
    ...
    <meta property="og:title" content="Visi Misi | UKM ORBIT UIN Sjech M.Djamil Djambek Bukittinggi" />
    ...
    <section class="welcome_about">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-10   ">
                    <h2>Visi & Misi UKM ORBIT</h2>
                    <div class="col-md-6">

                        <img src="<?php echo base_url() . 'theme/image/logoorbit.png' ?>" alt="Logo Orbit">
                    </div>
                    <h5>Visi</h5>
                    <p>Menjadi Pusat Pengembangan, Pengelolaan, dan Pelayanan Teknologi Informasi dan Komunikasi Yang Terkemuka Secara Internasional</p>
                </div>
                <div class="col-md-10">
                    <h5>Misi</h5>
                    <ol>
                        <li>Mengembangkan Teknologi Informasi dan Komunikasi Sesuai Perkembangan Zaman</li>
                        <li>Mengelola Teknologi Informasi dan Komunikasi Secara Baik dan Terencana Untuk Mendukung Penyelenggaraan Tri Darma Perguruan Tinggi.</li>
                        <li>Memberikan Pelayanan Secara Baik dan Berkualitas</li>
                        <li>Menjalin Kerja Sama Dalam Bidang Teknologi dan Komunikasi Dengan Intra Terkait</li>
                        <li>Menjadikan Organisasi Ini Menjadi Keluarga Kedua Dan Menegakkan Sosialisasi Yang tinggi</li>
                    </ol>
                </div>
                <!-- <div class="col-md-12">
                    <h5>Tujuan</h5>
                    <ol>
                        <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Rem ipsa eaque, ratione beatae et vero qui! Accusamus, pariatur nihil! Temporibus in libero corrupti, totam deserunt adipisci? Vitae eaque odit quae!</li>
                    </ol>
                </div> -->
            </div>
        </div>
